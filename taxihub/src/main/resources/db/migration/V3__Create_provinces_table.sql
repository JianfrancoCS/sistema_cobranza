...
CREATE TABLE tbl_provincias (
    ...
    -- Índices
    UNIQUE KEY UQ_provincias_nombre_dept_activo (nombre, departamento_id, activo),
    KEY IX_provincias_nombre (nombre),
    KEY IX_provincias_departamentos (departamento_id),
    KEY IX_provincias_fecha_creacion (fecha_creacion),
    KEY IX_provincias_activo (activo)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

INSERT INTO tbl_provincias (departamento_id, nombre) VALUES
(1, 'CHACHAPOYAS'),
(1, 'BAGUA'),
(1, 'BONGARA'),
(1, 'CONDORCANQUI'),
